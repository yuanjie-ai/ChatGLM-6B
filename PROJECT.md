...
* [ChatLLM/ChatPDF](https://github.com/yuanjie-ai/ChatLLM): 基于 ChatGLM 应用
  * 兼容 openai 生态 `pip install "chatllm[openai]" && chatllm-run openai "THUDM/chatglm-6b"`
  * 支持 ChatBase/ChatWeb/ChatPDF/ChatANN/ChatWeb 等应用，支持多种模型基座：chatglm/bloom/llama 等 。
